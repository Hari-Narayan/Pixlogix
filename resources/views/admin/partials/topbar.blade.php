            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    @if (Auth::user()->profile_photo)
                        <img src="{{ Auth::user()->profile_photo }}" class="img-circle elevation-2 mr-2 user-img" alt="User Image">
                    @else
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="{{ route('auth.change_password') }}" class="dropdown-item">
                        ...
                        @lang('admin.top-bar.drop-down.change-password')
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="#logout" data-toggle="modal" data-target="#signout_modal" class="dropdown-item">
                        <i class="fa fa-sign-out-alt mr-2"></i>
                        @lang('admin.top-bar.drop-down.sign-out')
                    </a>
                </div>
            </li>
        </ul>
